...
plStrumGS2.addParamToGroup('GENERAL', TnfxParameter(0, 'Play Mode', 0, 'Guitar ', False, 2) )
plStrumGS2.addParamToGroup('GENERAL', TnfxParameter(4, 'Strum-Auto', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('EQ', TnfxParameter(97, 'EQ On', 0, 'On ', False, 1) )
...
plStrumGS2.addParamToGroup('EQ', TnfxParameter(96, 'EQ SideChain', 0, 'Normal ', False, 1) )
plStrumGS2.addParamToGroup('COMPRESSOR', TnfxParameter(104, 'On', 0, 'On ', False, 1) )
...
plStrumGS2.addParamToGroup('COMPRESSOR', TnfxParameter(103, 'Pre', 0, 'Off ', False, 1) )
plStrumGS2.addParamToGroup('REVERB', TnfxParameter(239, 'Rvb On', 0, 'On ', False, 1) )
...
plStrumGS2.addParamToGroup('AMP', TnfxParameter(252, 'Amplifier - Bite', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('AMP', TnfxParameter(261, 'Amplifier - Amplifier On', 0, 'On ', False, 1) )
plStrumGS2.addParamToGroup('AMP', TnfxParameter(262, 'Amplifier - Spring Reverb Mix', 0, '20.0%ˀ ', False) )
plStrumGS2.addParamToGroup('AMP', TnfxParameter(263, 'Amplifier - Spring Reverb On', 0, 'Off ', False, 1) )
plStrumGS2.addParamToGroup('AMP', TnfxParameter(264, 'Amplifier - Cabinet Open', 0, 'Closed ', False) )
plStrumGS2.addParamToGroup('AMP', TnfxParameter(265, 'Amplifier - Cabinet On', 0, 'On ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1', TnfxParameter(105, 'On/Off', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 DELAY', TnfxParameter(109, 'Dly Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 PHASER', TnfxParameter(124, 'Phsr Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 VINTAGE CHORUS', TnfxParameter(131, 'Vin-Cho Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 CHORUS', TnfxParameter(139, 'Chorus Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 FLANGER', TnfxParameter(146, 'Flanger Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 TREMOLO', TnfxParameter(151, 'Trem Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 WAH-WAH', TnfxParameter(161, 'Wah-Wah Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-1 NOTCH FILTER', TnfxParameter(166, 'Notch Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2', TnfxParameter(169, 'On/Off', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 DELAY', TnfxParameter(173, 'Dly Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 PHASER', TnfxParameter(188, 'Phsr Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 VINTAGE CHORUS', TnfxParameter(195, 'Vin-Cho Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 CHORUS', TnfxParameter(203, 'Chorus Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 FLANGER', TnfxParameter(210, 'Flanger Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 TREMOLO', TnfxParameter(215, 'Trem Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 WAH-WAH', TnfxParameter(225, 'Wah-Wah Sync On', 0, 'Off ', False, 1) )
...
plStrumGS2.addParamToGroup('FX-2 NOTCH FILTER', TnfxParameter(230, 'Notch Sync On', 0, 'Off ', False, 11) )
